...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 relative ">
        ...
        <div className="flex items-center">
          ...
          <div
            className={`transition-all duration-500 ease-in-out overflow-hidden absolute left-0 right-0 bg-white dark:bg-gray-900 ${
              isOpen
            ...
            style={{ zIndex: 100 }}
          >
            <ul className="font-medium flex flex-col p-4 md:p-0 border border-gray-100 rounded-lg bg-white md:flex-row md:space-x-8 rtl:space-x-reverse md:border-0 dark:bg-gray-900  dark:border-gray-700">
              <li>
                <NavLink
                  to="/TokenHolders/"
